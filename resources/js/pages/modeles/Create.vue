<template>
  <AppLayout title="Nouveau modèle">
    <div class="py-12">
      <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6">
            <!-- En-tête -->
            <div class="mb-6">
              <h1 class="text-2xl font-bold text-gray-900">Nouveau modèle d'équipement</h1>
              <p class="mt-1 text-sm text-gray-600">
                Ajoutez un nouveau modèle d'équipement de climatisation
              </p>
            </div>
            ...
            <form @submit.prevent="submit">
              ...
              <div class="flex justify-end space-x-4">
                ...
                >
                  ...
                  <span v-else>Créer le modèle</span>
                </button>
              </div>
            </form>
          </div>
...
const form = useForm({
  ...
  description: '',
  quantite_gaz_kg: null as number | null,
  type_gaz_id: '',
  modele_releve_defaut_id: '',
})

const submit = () => {
  form.post(route('modeles.store'))
}
