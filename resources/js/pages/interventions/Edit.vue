        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
            <div class="flex justify-between items-center mb-6">
              <div>
                <h2 class="text-2xl font-bold text-gray-900">Modifier l'Intervention</h2>
                <p class="text-gray-600">Modification de l'intervention technique</p>
              </div>
              <Link
            ...
            <form @submit.prevent="submit" class="space-y-6">
              ...
              <div class="flex items-center justify-end space-x-4 pt-6">
                ...
                >
                  <span v-if="form.processing">Modification en cours...</span>
                  <span v-else>Modifier l'intervention</span>
                </button>
              </div>
            </form>
          </div>
...
// Le useForm d'Inertia.js pour la modification pré-remplit les champs avec les données existantes
const form = useForm({
  panne_id: props.intervention.panne_id || null,
  date_intervention: props.intervention.date_intervention,
  type_intervention: props.intervention.type_intervention,
  equipement_id: props.intervention.equipement_id,
  technicien_id: props.intervention.technicien_id,
  description: props.intervention.description,
  observations: props.intervention.observations || '',
  duree_estimee: props.intervention.duree_estimee || '',
  cout_main_oeuvre: props.intervention.cout_main_oeuvre || '',
  cout_pieces: props.intervention.cout_pieces || '',
  statut: props.intervention.statut
})

const submit = () => {
  // Pour la modification, on utilise la méthode PUT vers la route update
  form.put(route('interventions.update', props.intervention.id))
}
</script> 